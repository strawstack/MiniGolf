let data = {
    ...
    <rect id="background" width="1200" height="1200" fill="#C4C4C4"/>
    <rect id="course" x="242" y="458" width="715" height="284" fill="#C4C4C4"/>
    <rect id="hole" x="835" y="580" width="40" height="40" fill="#C4C4C4"/>
    <rect id="mat" x="326" y="566" width="70" height="70" fill="#C4C4C4"/>
    <rect id="ball" x="349" y="589" width="24" height="24" fill="#C4C4C4"/>
    ...
    <rect id="background" width="1200" height="1200" fill="#C4C4C4"/>
    <rect id="course" x="242" y="458" width="715" height="284" fill="#C4C4C4"/>
    <rect id="hole" x="635" y="680" width="40" height="40" fill="#C4C4C4"/>
    <rect id="mat" x="326" y="566" width="70" height="70" fill="#C4C4C4"/>
    <rect id="ball" x="349" y="589" width="24" height="24" fill="#C4C4C4"/>
    <rect class="wall" x="242" y="408" width="715" height="50" fill="#C4C4C4"/>
    <rect class="wall" x="242" y="742" width="715" height="50" fill="#C4C4C4"/>
